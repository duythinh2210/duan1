...
?>
<section id="header">
    <a href="index.php"><img src="layout/img/logo7.png" class="logo" alt=""></a>
    <div>
        <ul id="navbar">
            <div class="col3">
                <!-- Biểu mẫu tìm kiếm -->
            ...
            <li><a href="index.php?pg=shop">DANH MỤC</a></li>
            ...
            <?php if (is_user_logged_in()): ?>
                ...
                <li id="id_user">
                    ...
                    <a  id="user"><img src="./layout/img/people/1.png<?=$user_profile['hinh']?>" alt="" width="36px" height="36px" style="border-radius: 50%!important;"></a>
                </li>
                <li id="lg-bag">
